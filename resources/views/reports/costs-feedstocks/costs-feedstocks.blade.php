    ...
    <div class="container d-flex justify-content-center mb-4">
        <div class="card col-12 col-md-10 col-lg-6">
            ...
            <div class="card-body">
                ...
                {{ Form::open(['route' => 'reports.costs-feedstocks', 'class' => 'needs-validation']) }}
                    <div class="form-group mb-3">
                        {{ Form::label('feedstock_id','Insumo Específico?') }}
                        {{ Form::select('feedstock_id', $feedstocks,null,['class' => 'form-select', 'placeholder' => 'Selecione', 'autocomplete' => 'off']) }}
                        <small>Caso deseje, informe um insumo específico (opcional)</small>
                    </div>
                    <div class="form-group mb-3">
