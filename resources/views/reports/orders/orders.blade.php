    ...
    <div class="container d-flex justify-content-center mb-4">
        <div class="card col-12 col-md-10 col-lg-6">
            ...
            <div class="card-body">
                ...
                {{ Form::open(['route' => 'reports.orders', 'class' => 'needs-validation']) }}
                    <div class="form-group mb-3">
                        {{ Form::label('customer_id','Cliente Específico?') }}
                        {{ Form::select('customer_id', $customers,null,['class' => 'form-select', 'placeholder' => 'Selecione', 'autocomplete' => 'off']) }}
                        <small>Caso deseje, informe um cliente específico (opcional)</small>
                    </div>
                    <div class="form-group mb-3">
